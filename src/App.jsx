...
import WomenShoes from './components women\'s/Official/shoes';
import OfficialWomenSuits from './components women\'s/Official/suits';
import WomenOfficial from './components women\'s/Official/officialpage';
import OfficialWomen from './components women\'s/Official/shirt';
import WomenCasual from './components women\'s/Casual/casual';
import WomenHoodies from './components women\'s/Casual/hoodies';
import WomenCasualShoes from './components women\'s/Casual/womenshoes';
import WomenSweatpants from './components women\'s/Casual/sweatpants';
import WomenTShirts from './components women\'s/Casual/t-shirts';
import KidsCasual from './components kid\'s/Casual/casual';
import KidsHoodies from './components kid\'s/Casual/hoodies';
import KidsShoes from './components kid\'s/Casual/shoes';
import KidsTShirts from './components kid\'s/Casual/t-shirts';
import KidsSweatpants from './components kid\'s/Casual/sweatpants';
